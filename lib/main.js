...
var require_signing = __commonJS({
  "lib/signing.js"(exports2) {
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.signAabFile = exports2.signApkFile = void 0;
    ...
    function signApkFile(apkFile, signingKeyFile, alias, keyStorePassword, keyPassword) {
      return __awaiter2(this, void 0, void 0, function* () {
        core2.debug("Zipaligning APK file");
        ...
        if (!fs.existsSync(buildTools)) {
          core2.error(`Couldnt find the Android build tools @ ${buildTools}`);
        }
        const zipAlign = path.join(buildTools, "zipalign");
        core2.debug(`Found 'zipalign' @ ${zipAlign}`);
        ...
        core2.debug("Signing APK file");
        const apkSigner = path.join(buildTools, "apksigner");
        core2.debug(`Found 'apksigner' @ ${apkSigner}`);
        ...
        core2.debug("Verifying Signed APK");
    ...
    exports2.signApkFile = signApkFile;
    function signAabFile(aabFile, signingKeyFile, alias, keyStorePassword, keyPassword) {
      return __awaiter2(this, void 0, void 0, function* () {
        core2.debug("Signing AAB file");
        const jarSignerPath = yield io2.which("jarsigner", true);
        core2.debug(`Found 'jarsigner' @ ${jarSignerPath}`);
        const args = [
          "-keystore",
          signingKeyFile,
          "-storepass",
    ...
    exports2.signAabFile = signAabFile;
  }
});

// lib/io-utils.js
var require_io_utils = __commonJS({
  "lib/io-utils.js"(exports2) {
    "use strict";
    var __importDefault2 = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.findReleaseFile = exports2.getReleaseFile = void 0;
    ...
    exports2.getReleaseFile = getReleaseFile;
    function findReleaseFile(releaseDir) {
      const releaseFiles = fs_12.default.readdirSync(releaseDir, { withFileTypes: true }).filter((item) => !item.isDirectory()).filter((item) => item.name.endsWith(".apk") || item.name.endsWith(".aab"));
      return getReleaseFile(releaseFiles);
    }
    exports2.findReleaseFile = findReleaseFile;
  }
});
...
var io = __importStar(require_io_utils());
function run() {
